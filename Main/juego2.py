...
preguntas={
    ...
    "2":[("resuelve la siguiente ecuacion lineal: 3x+2=20",["A. X=6","B. X=4"],"A"),
    ...
    "3":[("resuelve la siguiente division de polinomios de tal forma que el resultado sea P(x)=D(x)*Q(x)+R(x). Donde P(X)=2x^(4)-x^(3)+7x^(2)-2x-2 y D(x)=(2x^(2)-x+1)",["A. P(X)=2x^(4)-x^(3)+7x^(2)-2x-2= (2x^(2)-x+1)(x^(2)+3)+(x-5)","B. P(X)=2x^(4)-x^(3)+7x^(2)-2x-2= (2x^(2)-x+1)(x^(2)-5)+(x+8)"],"A"),
               ...
               ("calcula el limite para x que tiende a infinito de 3+(5/x^(2))/2+(7/x^(2))",["A. 0","B. 3"],"B"),
